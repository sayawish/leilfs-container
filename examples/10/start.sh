...
export LEILFS_GATEWAY="${LEILFS_GATEWAY:-172.32.0.1}"
export FLOATING_IP="${FLOATING_IP:-172.32.0.10}"
export MASTER1_IP="${MASTER1_IP:-172.32.0.11}"
...
export CLUSTER_NETWORK_NAME="${CLUSTER_NETWORK_NAME:-leilfs-10-net}"
